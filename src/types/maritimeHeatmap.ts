...
export interface MaritimeFleetHeatmapBounds {
  west: number;
  south: number;
  east: number;
  north: number;
...
export interface MaritimeFleetHeatmapCell {
  ...
  lat: number;
  lon: number;
  geometryBounds: MaritimeFleetHeatmapBounds | null;
...
export interface MaritimeFleetHeatmapCoverage {
  ...
  coverageKind: MaritimeFleetHeatmapCoverageKind | null;
  qualityBand: MaritimeFleetHeatmapQualityBand | null;
  coverageNote: string | null;
}
